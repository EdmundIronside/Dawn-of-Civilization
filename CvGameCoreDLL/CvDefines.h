...
#ifdef _USRDLL
#define MAX_CIV_PLAYERS												(50) //Rhye, Leoreth: +17 for Byzantium, Korea, Indonesia, Mughals, Thailand, Turks, Prussia/HRE, Italy, Tamils, Poland, Moors, Congo, Tibet, Brazil, Zulu, Argentina, Canada, Polynesia, Harappa
#else
